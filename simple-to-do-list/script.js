...
/* Step 11 below here */
function doAbout() {
var ss1= document.getElementById("divAbout");
  ss1.innerHTML= "The name of the author is Rafiul Ratul";
  ss1.className= "aboutcolor";
}
